...
void GlassTube::Init()
{
	...
	{
		SetGlass(messageTable, "graphics/Map/Object/tutorial_skill_1.png", "¹Ù¶÷º£±â ±âÃÊ");
	}
	else if (GetFileName() == "graphics/Map/Object/tutorial_skill_2.png")
	{
		SetGlass(messageTable, "graphics/Map/Object/tutorial_skill_2.png", "°øÁß Æø¹ß µ¹Áø");
	}
	else if (GetFileName() == "graphics/Map/Object/tutorial_skill_3.png")
	{
		SetGlass(messageTable, "graphics/Map/Object/tutorial_skill_3.png", "¿ëÀÇ ºÒ¼û");
	}
	else if (GetFileName() == "graphics/Map/Object/tutorial_skill_4.png")
	{
		SetGlass(messageTable, "graphics/Map/Object/tutorial_skill_4.png", "Æø¹ß È­¿°±¸");
	}
