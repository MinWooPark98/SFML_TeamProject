...
RayCast::RayCast(const Vector2f& pos, const Vector2f& dir, float len)
	:startPos(pos), direction(dir), rayLength(len), rayHit(false), /*layerMask(-1),*/ objType(Object::ObjTypes::None), closestObj(nullptr)
{
}
...
void RayCast::Update()
{
	...
	for (int i = 0; i < (int)Object::ObjTypes::Count; ++i)
	{
		...
		if(objType != Object::ObjTypes::None && (Object::ObjTypes)i != objType)
			continue;
